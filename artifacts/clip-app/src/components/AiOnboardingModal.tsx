        ...
        <TouchableOpacity activeOpacity={1}>
          <View style={s.card}>
            ...
            <Text style={s.description}>
              {"Clip умеет делать конспекты статей с помощью AI — ключевые идеи, объяснение терминов, взгляд на материал.\n\nБесплатно: 2 анализа в день на DeepSeek, без ключа. Хочешь больше или другую модель — добавь свой ключ, платишь провайдеру напрямую, обычно это несколько центов за статью."}
            </Text>
